    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-rose-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-5xl font-extrabold bg-gradient-to-r from-red-500 to-rose-500 bg-clip-text text-transparent">
            23
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-3 bg-gradient-to-r from-red-500 to-rose-500 text-white font-semibold text-sm uppercase tracking-wider">
