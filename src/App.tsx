    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-rose-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-5xl font-extrabold bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">
            23
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-3 bg-gradient-to-r from-red-600 to-rose-600 text-white font-semibold text-sm uppercase tracking-wider">
          ...
          {rows.map(({ multiplier, product }, index) => (
            <div
              key={multiplier}
              className={`grid grid-cols-3 transition-colors hover:bg-red-50 ${
            ...
            >
              ...
              <div className="px-6 py-3.5 text-center font-bold text-red-700">
                <span className="text-red-300 text-sm mr-1">=</span>
                {product}
              </div>
            </div>
          ))}
